...
Depending on your choice we will then resume with creating a first plug-in in either [Creating an import format plug-in]({% link docs/getting_started/import_format.md %}) or [Create your first import automation]({% link docs/getting_started/import_automation.md %}).