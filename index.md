...
In the following section [Setup]({% link docs/setup/index.md %}) we show you what is necessary for getting your development environment ready to write plug-ins. In [Writing plug-ins]({% link docs/writing_plugins/index.md %}) we then write, run and test a basic but fully functional plug-in step-by-step. The resulting plug-in project is an excellent starting point for developing your own plug-ins. [Debugging plug-ins]({% link docs/debugging_plugins.md %}) shows you how to analyze problems when your plug-in implementation is not behaving as expected. [Deploying plug-ins]({% link docs/deployment.md %}) deals with shipping and installing of your plug-ins. Finally, [Adcanced topics]({% link docs/plugin_fundamentals/index.md %}) consists of various articles talking about concepts and features useful for advanced plug-in development like user configuration and plug-in localization.
