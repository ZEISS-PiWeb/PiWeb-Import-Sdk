...
![Folder structure](../../assets/images/advanced_topics/structure/folder.png "Folder structure")
...
## Start assembly
The `assemblyPath` property in manifest.json defines the start assembly. If assemblyPath is not specified, the `id` is used to determine the name of the assembly. The given assembly must provide a class that implements `IPlugin`.
...
![Localization](../../assets/images/advanced_topics/structure/localization.png "Localization")
