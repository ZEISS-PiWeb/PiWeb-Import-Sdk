...
## CreateConfiguration
Besides `CreateImportRunner` from [Writing an import format plug-in]({% link docs/writing_plugins/import_automation.md %}) you can use `CreateConfiguration` to load custom configuration items.
