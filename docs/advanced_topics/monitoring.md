...
![Show application log](../../assets/images/advanced_topics/monitoring/applogbutton.png "Show application log")

{: .note }
The application log can also be found under `%AppData%\..\Local\Zeiss\PiWeb`.

Example message:\
![Log content](../../assets/images/advanced_topics/monitoring/applogcontent.png "Log content")
...
![Show import log](../../assets/images/advanced_topics/monitoring/importlogbutton.png "Show import log")

Example message:\
![Import log content](../../assets/images/advanced_topics/monitoring/importlogcontent.png "Import log content")
...
![Activities](../../assets/images/advanced_topics/monitoring/activities.png "Activities")
...
![Latest events](../../assets/images/advanced_topics/monitoring/events.png "Latest events")